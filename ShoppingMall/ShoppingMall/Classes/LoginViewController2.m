...
-(void)initSubviews
{
    ...
    self.fogetpwdLabel.font = [UIFont fontWithName:@"Arial" size:10.0f];
    ...
    self.phonetxt.font = [UIFont fontWithName:@"Arial" size:12.0f];
    ...
    self.pwdtxt.font = [UIFont fontWithName:@"Arial" size:12.0f];
    ...
    //self.boxview.autoresizesSubviews = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
...
-(void)setLayout
{
    ...
    [self.boxview addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-20-[_signinBtn(100)]-(>=1)-[_signupBtn(100)]-20-|" options:NSLayoutFormatAlignAllTop|NSLayoutFormatAlignAllBottom metrics:nil views:box1dict]];
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"H:[_boxview(%f)]-<=1-[supperview]",self.view.frame.size.width-20] options:NSLayoutFormatAlignAllCenterY metrics:nil views:superviewdict]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"V:[_boxview(%f)]-<=1-[supperview]",self.view.frame.size.height/2.5] options:NSLayoutFormatAlignAllCenterX metrics:nil views:superviewdict]];
    //[self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-[_boxview]-|" options:0 metrics:nil views:superviewdict]];
